...
.PARAMETER Clean
Removes the image angular2-webpack-skeleton and kills all containers based on that image.
...
Build a Docker image named angular2-webpack-skeleton
#>
...
$imageName="angular2-webpack-skeleton"
$projectName="angular2webpackskeleton"
$publicPort=3000
